...
# # model.save("./_save/keras22_3_save_model.keras")         #  ./ = 파일경로 지정  # 상대경로방식
# model.save("c:/nsu_work/_save/keras22_3_save_model.keras")    # 절대경로방식  

model = load_model("c:/nsu_work/_save/keras22_3_save_model.keras")
# 22_3에서 훈련한 가중치 모델이 들어 있기때문에 평가, 예측에서도 같은 값
